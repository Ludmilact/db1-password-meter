...
public class ResultadoDeAnaliseSomenteNumeros extends ResultadoDeAnalise {
    ...
    private void calcularResultado(String senha) {
        int quantidadeDeEspacos = ValidaRequisitos.obterQuantidadeDeEspacos(senha);
        int quantidadeDeNumerosEEspacos = ValidaRequisitos.obterQuantidadeDeNumeros(senha) +
                quantidadeDeEspacos;
